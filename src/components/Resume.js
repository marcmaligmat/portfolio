          ...
          <ul className="experience">
            ...
            <li>
              ...
              <div className="content">
                <h4>Callsine</h4>
                <h5>callsine.com, Philadelphia, PA</h5>
                <p className="info">
            ...
            <li>
              <span className="line-left" />
              <div className="content">
                <h4>Deals Armament</h4>
                <h5>dealsarmament.com/deals, North Carolina</h5>
                <p className="info">
                  Dealsarmament is a platform for finding best offers every day
                  in United States everything about guns and accessories
                </p>
              </div>
              <span className="year">
                <span className="to">2024</span>
