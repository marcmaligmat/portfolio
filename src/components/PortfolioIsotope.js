        ...
        <div className="row portfolio-items mb-50">
            ...
            <a
              ...
              onClick={() =>
                handleOnClickProject({
                  projectTitle: "Callsine",
                  description:
                    "CallSine™ is a patent pending sales outreach tool designed for salespeople and teams seeking to scale up high quality, personalized outreach leveraging AI.",
                  client: "Logan Kelly",
                  website: "https://www.callsine.com",
                  imgDirectory1: "img/portfolio/callssine-website.png",
                  techStack: "NextJS, Node, Typescript, Docker,Python,Django",
                })
              }
            >
              <figure>
                <img src="img/portfolio/callssine-website.png" alt="" />
                <figcaption>
                  <h4>Callsine</h4>
                  <p>callsine.com</p>
                  <p>Scraper</p>
          ...
          <div className="item col-lg-4 col-sm-6 brand design">
            <a
              ...
              onClick={() =>
                handleOnClickProject({
                  projectTitle: "Deals Armament",
                  description:
                    "Dealsarmament is a  platform for finding best offers every day in United States everything about guns and accessories",
                  client: "Adan Dela Cruz",
                  website: "https://dealsarmament.com/deals",
                  imgDirectory1: "img/portfolio/dealsarmament-website.png",
                  techStack: "NextJS, Node, Typescript, Docker,Python,Django",
                })
              }
            >
              <figure>
                <img src="img/portfolio/dealsarmament-website.png" alt="" />
                <figcaption>
                  <h4>Dealsarmament</h4>
                  <p>dealsarmament.com</p>
                  <p>Scraper</p>
                </figcaption>
              </figure>
            </a>
